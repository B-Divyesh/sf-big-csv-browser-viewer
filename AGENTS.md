# Open, filter and pivot multi-million-row CSVs entirely in the browser (`big-csv-browser-viewer`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://big-csv-browser-viewer.sociobot.in`. Artifact class: `static-web`.
